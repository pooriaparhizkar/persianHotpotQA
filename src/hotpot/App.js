    ...
    >
      ...
      <Card className="support" title="تولید نمونه داده">
        <Space direction="vertical" size="large" style={{ display: "flex" }}>
          ...
          <Text type="danger">
            در این طرح ما دارای دو نوع سوال هستیم: سوال مقایسه ای و سوال پل.
            سوال مقایسه ای به مقایسه بین دو موجودیت می پردازد که معمولا جواب آن
            بله/ خیر یا یک موجودیت است برای مثال "از بین علی دایی و علی کریمی چه
            کسی تعداد گل های ملی بیشتری دارد؟". سوال پل، سوالی است که از دو زیر
            سوال تشکیل شده است برای مثال "نویسنده کتاب شاهنامه متولد چه قرنی می
            باشد؟"( در این سوال ابتدا لازم است بدانیم نویسنده کتاب شاهنامه چه
            کسی است؟ سپس با توجه به نام نویسنده قرن تولد آن را پیدا کنیم.
          </Text>
          <Text type="danger">
            نوع پاسخ سوال نیز باید براساس یکی از دسته بندی هایی که مشخص شده است،
            تعیین شود.
          </Text>
